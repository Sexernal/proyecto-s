        ...
        <div class="galeria-estadio">
            ...
            <div class="carrusel-fotos">
                ...
                <div class="carrusel-item active">
                    <img src="imagen/estadio/entrada" alt="Entrada original">
                    <div class="carrusel-desc">
                        <p>Entrada original para asistir a la inauguración del Ricardo Saprissa</p>
                    </div>
                </div>
                <!-- Foto 2 -->
                <div class="carrusel-item">
                    <img src="imagen/estadio/ricardo" alt="Ricardo Saprissa">
                    <div class="carrusel-desc">
                        <p>Ricardo Saprissa en el primer día del estadio que lleva su nombre</p>
                    </div>
                </div>

                <div class="carrusel-item">
                    <img src="imagen/estadio/foto" alt="foto">
                    <div class="carrusel-desc">
                        <p>Foto tomada el día de la propia inauguración del Estadio Saprissa</p>
                    </div>
                </div>

                <div class="carrusel-item">
                    <img src="imagen/estadio/flaco" alt="flaco chavarria">
                    <div class="carrusel-desc">
                        <p>"Flaco" Chavarría celebrando el primer tanto saprissista en La Cueva</p>
                    </div>
                </div>
        ...
        <div class="datos-curiosos">
            ...
            <div class="tarjetas-curiosos">
                ...
                <div class="tarjeta-curioso">
                    <div class="icono-curioso">🏷️</div>
                    <h4>Apodo</h4>
                    <p>"La Cueva del Monstruo".</p>
                </div>
                <!-- Tarjeta 5: Récord de Asistencia -->
                <div class="tarjeta-curioso">
                    <div class="icono-curioso">👥</div>
                    <h4>Récord de Asistencia</h4>
                    <p>25,000 personas (en un partido contra Alajuelense).</p>
                </div>
                <!-- Tarjeta 6: Primer Gol -->
                <div class="tarjeta-curioso">
                    <div class="icono-curioso">⚽</div>
                    <h4>Primer Gol</h4>
                    <p>Anotado por Peter Sandoval (Comunicaciones) en 1972.</p>
                </div>
                <!-- Tarjeta 7: Eventos Internacionales -->
                <div class="tarjeta-curioso">
                    <div class="icono-curioso">🌍</div>
                    <h4>Eventos Internacionales</h4>
                    <p>Sede de la Copa de Oro y otros torneos.</p>
                </div>
                <!-- Tarjeta 8: Renovaciones -->
                <div class="tarjeta-curioso">
                    <div class="icono-curioso">🔧</div>
                    <h4>Renovaciones</h4>
                    <p>Asientos individuales y mejoras en iluminación y sonido.</p>
                </div>
            </div>
        </div>
